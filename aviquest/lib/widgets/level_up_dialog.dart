...
class LevelUpDialog extends StatelessWidget {
    ...
    return Dialog(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: Colors.amber.withOpacity(0.3), blurRadius: 40, spreadRadius: 8),
          ],
        ),
        child: Column(
          ...
          children: [
            ...
            const Text('⭐', style: TextStyle(fontSize: 72))
                ...
                .then()
                .shimmer(duration: 1200.ms, color: Colors.amber.withOpacity(0.6)),
            ...
            ElevatedButton(
              ...
              child: const Text('Continue Birding!'),
  ...
  static String _motivationalText(int level) {
    if (level >= 30) return 'You are a true master of the avian world!';
    if (level >= 20) return 'Your knowledge of birds is truly impressive!';
    if (level >= 15) return 'The birds sing songs of your dedication!';
    if (level >= 10) return 'Your aviary grows ever more magnificent!';
    if (level >= 5) return 'You\'re becoming a skilled birder!';
    return 'Every journey starts with a single feather!';
  }
}
