...
class FieldGuideTab extends StatefulWidget {
  ...
  const FieldGuideTab({super.key, required this.onBirdTapped});
...
class _FieldGuideTabState extends State<FieldGuideTab> {
  ...
  Widget build(BuildContext context) {
    final filtered = BirdService.birds.where((b) {
      final matchRarity = _rarityFilter == 'all' || b.rarity == _rarityFilter;
      final matchSearch = _search.isEmpty ||
          b.name.toLowerCase().contains(_search.toLowerCase()) ||
          b.scientificName.toLowerCase().contains(_search.toLowerCase());
                ...
                child: GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: selected ? color.withAlpha(51) : bgCard,
            ...
            itemBuilder: (c, i) {
              ...
              return Card(
                ...
                child: ListTile(
                        ...
                        Row(children: [
                          Container(
                            ...
                            child: Text(bird.rarity,
                                style: TextStyle(
                                    color: bird.rarityColor, fontSize: 10)),
                          ),
                  ...
                  onTap: () => widget.onBirdTapped(bird),
                ),
