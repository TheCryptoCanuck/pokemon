...
class DogDetailSheet extends StatefulWidget {
  ...
  static void show(BuildContext context, Dog dog, AudioPlayer player,
            ...
            children: [
              Container(
                ...
                child: Text(
                  dog.rarity.label,
                  style: TextStyle(
                      color: dog.rarity.color, fontWeight: FontWeight.bold),
                ),
              ),
          ...
          if (dog.rarity == Rarity.unknown)
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border:
                    Border.all(color: dog.rarity.color.withValues(alpha: 0.4)),
              ),
              child: Center(
