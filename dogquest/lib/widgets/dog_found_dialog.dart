...
import 'package:dogquest/widgets/rarity_discovery_badge.dart';
import 'package:dogquest/widgets/share_dog_card.dart';
        ...
        Dialog(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              border: _isSpecial
                  ? Border.all(
                      color: dog.rarity.color.withValues(alpha: 0.8),
                      width: 2,
                    )
                  : null,
