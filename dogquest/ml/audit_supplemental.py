...
MODEL_PATH = BASE_DIR / "assets" / "dog_model.tflite"
LABELS_PATH = BASE_DIR / "assets" / "dog_labels.txt"
SUPPLEMENTAL_DIR = BASE_DIR / "supplemental_dogs"
REPORT_PATH = BASE_DIR / "audit_report.txt"
GALLERY_PATH = BASE_DIR / "audit_gallery.html"
FLAGGED_JSON_PATH = BASE_DIR / "audit_flagged.json"
INPUT_SIZE = 224
...
def main():
    ...
    print(f"Written: {FLAGGED_JSON_PATH} ({len(flagged_list)} flagged images)")
...
"""
    ...
    for breed_name, results in by_breed.items():
        ...
        for r in sorted_results:
            ...
            # Use file:// protocol for local images (r["file"] is already absolute)
            img_path = r["file"].replace("\\", "/")
