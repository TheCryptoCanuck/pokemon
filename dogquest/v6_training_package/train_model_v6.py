...
FINE_TUNE_LAYERS_STAGE = [60, -1]     # -1 = unfreeze all
...
def build_train_pipeline(img_size, stage_name="train"):
...
for stage_idx, (img_size, ft_epochs, ft_layers) in enumerate(
    ...
    train_ds, steps_per_epoch = build_train_pipeline(img_size, stage_name=stage_name)
